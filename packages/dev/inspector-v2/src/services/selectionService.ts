...
import { ShowPropertiesOnEntitySelectionStorageKey } from "./settings";
...
export const SelectionServiceDefinition: ServiceDefinition<[ISelectionService], [IShellService]> = {
    ...
    factory: (shellService) => {
        ...
        const setSelectedItem = (item: Nullable<unknown>) => {
            if (item !== selectedEntityState) {
                ...
                if (item && DataStorage.ReadBoolean(ShowPropertiesOnEntitySelectionStorageKey, true)) {
